      ...
      <div>
        <form className="flex grow flex-col justify-between">
          ...
          <div className="relative">
            {isOpen && (
              <div className="absolute -top-[330px] w-full rounded-3xl border border-violet-700 bg-stone-900 p-4 transition delay-150 duration-300 ease-in-out">
                <div className="custom-scrollbar max-h-[282px] overflow-y-scroll">
                  {Object.entries(selectedItems).map(([key, value]) => {
                    return (
                      <div
                        className={`${
                          value ? "bg-[#252525]" : ""
                        } w-[97%] rounded-lg px-4 py-2`}
                        key={key}
                      >
            ...
            <div className="inline-flex h-12 w-full items-center justify-center gap-3 rounded-3xl border border-neutral-700 bg-stone-900 px-5 py-3.5">
              <p>#selected tags</p>
